...
public class CustomerFacade {
    ...
    public static void main(String[] args) {
        ...
        Customer c1 = facade.addCustomer("John", "Locke");
        Customer c2 = facade.addCustomer("Murray", "Rothbard");
        Customer c3 = facade.addCustomer("Ludwig", "von Mises");
        Customer c4 = facade.addCustomer("Ludwik", "Zamenhof");
        Customer c5 = facade.addCustomer("Walter", "Block");

        System.out.println("\nFind customer by ID");
        System.out.println("Customer 2 " + facade.findByID(c2.getId()).getFirstName());

        System.out.println("\n Find by lastname \"von Mises\"");
        System.out.println(facade.findByLastName("von Mises"));
